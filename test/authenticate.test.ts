...
import authenticate from "../src/api/v1/middleware/authenticate"; // <-- Update path
import { auth } from "../config/firebaseConfig"; // <-- Update path
import { AuthenticationError } from "../src/api/v1/errors/errors"; // <-- Update path
